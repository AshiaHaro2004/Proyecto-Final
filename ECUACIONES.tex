...
%TCIDATA{LastRevised=Tuesday, May 19, 2026 14:33:54}
...
t\right) =\frac{1}{C}\int \left[ i_{1}\left( t\right) -i_{2}\left( t\right) %
\right] dt 
\]
...
$\ \ \ \ \ \ \left( 2\right) $%
\[
L_{s}I_{2}\left( s\right) +\left( R_{2}+R_{3}\right) i_{2}\left( s\right) =%
\frac{1}{C}\left[ i_{1}\left( s\right) -i_{2}\left( s\right) \right] 
\]
...
\[
I_{2}(s)\{R_{1}[LCs^{2}+R_{1}C(R_{2}+R_{3})s+1]+L_{s}+\left(
R_{2}+R_{3}\right) \}=V_{e}\left( s\right) 
\]

Desarollamos:

\[
I_{2}(s)[R_{1}LCs^{2}+R_{1}C(R_{2}+R_{3})s+R_{1}+L_{s}+R_{2}+R_{3}=V_{e}%
\left( s\right) 
\]
...
\[
I_{2}(s)[R_{1}LCs^{2}+(L+R_{1}C(R_{2}+R_{3}))s+(R_{1}+R_{2}+R_{3})]=V_{e}%
\left( s\right) 
\]
...
\[
\frac{I_{2}(s)}{V_{e}\left( s\right) }=\frac{1}{%
R_{1}LCs^{2}+(L+R_{1}C(R_{2}+R_{3}))s+(R_{1}+R_{2}+R_{3})} 
\]
